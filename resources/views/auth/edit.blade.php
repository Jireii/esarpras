...
@section('content')
    ...
    <x-adminlte-card theme="success" theme-mode="outline"  title="Edit Profil">
        <main>
            ...
            <form action="/pengguna/{{ $user->id }}/edit" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <a href="{{ route('profile') }}" class="mr-auto">
                        <x-adminlte-button icon="fas fa-fw fa-long-arrow-alt-left" label="Kembali" theme="secondary" type="button" class="btn-sm" />
                    </a>
                    <x-adminlte-button icon="fas fa-fw fa-edit" label="Edit" theme="success" type="submit" class="btn-sm" />
                </div>
